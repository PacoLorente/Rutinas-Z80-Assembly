...
Disparo_0: DEFB $01,$80                          ;	Disparo (CTRL_DESPLZ)="0".
Disparo_0b: DEFB $07,$e0 						 ;  (No se imprime, detección de colisión).

Disparo_f9: DEFB $00,$60                         ;	Disparo (CTRL_DESPLZ)="f9"
Disparo_f9b: DEFB $01,$f8 					   	 ;  (No se imprime, detección de colisión).

Disparo_fb: DEFB $18,$00                         ;	Disparo (CTRL_DESPLZ)="fb"
Disparo_fbb: DEFB $7e,$00 						 ;  (No se imprime, detección de colisión).

Disparo_fd: DEFB $06,$00                         ;	Disparo (CTRL_DESPLZ)="fd"
